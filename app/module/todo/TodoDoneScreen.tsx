...
import { TodoDoneScreenProps, AppRoute } from '../../navigation';
...
const TodoDoneScreenComponent = (props: TodoDoneScreenProps & ThemedComponentProps): ListElement => {
...
export const TodoDoneScreen = withStyles(TodoDoneScreenComponent, (theme) => ({
  containerList: {
    flex: 1
  },
  containerEmpty: {
